...
namespace UWB_Texturing
{
    ...
    public static class MatrixArray
    {
        ...
        public static void LoadMatrixArrays_AssetsStored(out Matrix4x4[] WorldToCameraMatrixArray, out Matrix4x4[] ProjectionMatrixArray, out Matrix4x4[] LocalToWorldMatrixArray)
        {
            string matrixArrayFilepath = CrossPlatformNames.Matrices.Filepath;
