...
1. Clone project  
   ...
   `git clone https://github.com/UWB-ARSandbox/Android.git --recursive`  
...
2. Open Project  
   Open Unity and select 'Open'. Select the folder git just created for you (eg. "Documents/Android"). Unity will automatically generate any files that aren't synced with the project, such as the Library directory. 
